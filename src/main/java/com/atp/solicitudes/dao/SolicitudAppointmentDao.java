...
public interface SolicitudAppointmentDao
{
	...
	SolicitudAppointment getWithAppNbr(String app_nbr, List<String> listid) throws Exception;
	...
	DaoResult<SolicitudAppointment> query(DaoQuery query, DaoOrder order, Integer idTranporter) throws Exception;
