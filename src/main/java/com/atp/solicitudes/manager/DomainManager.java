...
public interface DomainManager
{
	...
	List<String> getdocumentos(String bls, String impe,String line,String fer,String u) throws Exception;
	List<String> getdocumentostodos(String bls, String impe,String line,String fer,String u) throws Exception;
	List<String> getdocumentoscon(String bls, String impe,String line,String fer,String u) throws Exception;
	List<String> getdocumentostra(String bls, String impe,String line,String fer,String u) throws Exception;
