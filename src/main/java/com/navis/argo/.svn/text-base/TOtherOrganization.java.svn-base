 ...
 * Other Organization
 * 
 * <p>Clase Java para tOtherOrganization complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="tOtherOrganization">
 *   &lt;complexContent>
...
@XmlType(name = "tOtherOrganization", propOrder = {
    "agentRepresentations"
})
public class TOtherOrganization
